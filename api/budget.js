        ...
        const aiRes = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            messages: [{ role: 'user', content: [
              ...
              { type: 'text', text: "Tu analyses une capture d'écran de l'application Revolut (budgets ou dépenses) d'Alexis, entrepreneur français.\n\nExtrais toutes les informations visibles et MAPPE chaque catégorie Revolut vers les catégories officielles d'Alexis :\n- Restaurant, repas → \"Restaurants\"\n- Bar, soirée, boîte, activité, karting, loisir, divertissement → \"Sorties\"\n- Beauté, coiffeur, soin, crème, cosmétique, parfum, style personnel → \"Style & Beauté\"\n- Vêtement, mode, fringue, textile → \"Vêtements\"\n- Complément alimentaire, protéine, whey, sport, nutrition → \"Nutrition & Sport\"\n- Transport, essence, gazole, carburant, train, métro, taxi, Uber → \"Transport\"\n- Supermarché, épicerie, alimentation, courses, marché → \"Courses\"\n- Achat divers, high-tech, matériel, équipement, Amazon, électronique → \"Achats\"\nSi une catégorie Revolut ne correspond à aucune, garde son nom original.\n\nRéponds UNIQUEMENT avec un JSON valide sans texte autour :\n{\n  \"month\": \"mois/période visible ou null\",\n  \"totalSpent\": montant_total_dépensé_nombre_ou_null,\n  \"totalBudget\": budget_total_nombre_ou_null,\n  \"balance\": solde_disponible_nombre_ou_null,\n  \"categories\": [\n    { \"name\": \"nom_mappé\", \"spent\": montant_dépensé_nombre, \"budget\": plafond_nombre_ou_null, \"percentage\": pourcentage_utilisé_ou_null }\n  ],\n  \"advice\": \"1-2 lignes de conseil concret sur le budget visible, en français\"\n}\n\nSi les chiffres ne sont pas lisibles, retourne categories:[] et explique dans advice." },
            ]}],
          }),
        });
